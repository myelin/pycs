...
#    "in your free time, check the sites dedicated",
    ...
    "lamisil",
    "zyban",
    "(free|online|cheap|play|video).(keno|slots|prozac|nexium|ambien|zyrtec|skelaxin|paxil|craps|bingo|didrex|renova|darvon|bextra)",
    "glucophage",
    "keno.game",
    "provigil",
    ...
    "dish.network",
    "fioricet",
    "(acyclovir|zyrtec|ambien|keno|valium|bextra|craps|jack|meridia|ativan).(online|strategy|odds)",
    "weight.loss",
    "zyprexa",
    "wrinkle.cream",
    "def.rimjob",
